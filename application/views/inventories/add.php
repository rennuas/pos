<div class="row">
    <div class="col-md-4">
        ...
        <form action="<?= site_url('Inventories/add'); ?>" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="sale_price" class="form-control money" value="0">
            </div>
            <div class="form-group">
                <label for="inputTelp">Harga Modal</label>
                <input type="text" name="capital_price" class="form-control money" value="0">
            </div>
            <div class="row">
                <div class="col">
                    <div class="form-group">
            ...
            <div class="form-group">
                ...
                <select name="delivery_type" id="inputDeliveryType" class="custom-select">
                    <?php foreach ($delivery_types as $type) : ?>
                        <option value="<?= $type['id']; ?>">Rp. <?= number_format($type['cost'], 0, ',', '.'); ?></option>
                    <?php endforeach; ?>
                </select>
                <div class="text-right">
                    <a class="ml-auto mt-1" type="button" data-toggle="modal" data-target="#addDeliveryType">Tambah Ongkos</a>
                </div>
            </div>
            <hr>
